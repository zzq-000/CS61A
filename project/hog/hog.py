...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            turn_scores = take_turn(num_rolls, score1, dice)
            score0 += turn_scores

            if feral_hogs and abs(num_rolls - previous0) == 2:
                score0 += 3
            previous0 = turn_scores
            if is_swap(score0, score1):
                score0, score1 = score1, score0
                
        elif who == 1:
            num_rolls = strategy1(score1, score0)
            turn_scores = take_turn(num_rolls, score0, dice)
            score1 += turn_scores
            
            if feral_hogs and abs(num_rolls- previous1) == 2:
                score1 += 3
            previous1 = turn_scores
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        if who == 0 and score0 - last_score > running_high:
            print(f'{score0 - last_score} point(s)! That\'s the biggest gain yet for Player {who}')
            return announce_highest(who, score0, score0 - last_score)

        elif who == 1 and score1 - last_score > running_high:
            high_gain = score1 - last_score
            print(f'{high_gain} point(s)! That\'s the biggest gain yet for Player {who}')
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    for i in range(10):
        try_average = average(i+1,dice)
        if try_average > max_score:
            max_score = try_average
            min_num_rolls = i + 1
...
def swap_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if is_swap(score + bacon_score, opponent_score):
        if score + bacon_score < opponent_score:
            return 0
        elif score + bacon_score > opponent_score:
            return num_rolls
